...
class TestCourierCreation:
    ...
    def test_create_courier_valid_data_courier_successfully_created(self, new_courier_data):
    ...
    def test_create_courier_existing_courier_error_is_returned(self, new_courier_data):
        body = new_courier_data
